...
## Corpus Check
- 113 files · ~222,591 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 666 nodes · 1136 edges · 65 communities (43 shown, 22 thin omitted)
...
- `WipeDatabaseZone()` --indirect_call--> `wipeDatabaseAction()`  [INFERRED]
  src/app/dashboard/settings/wipe-database-zone.tsx → src/app/dashboard/settings/actions.ts
...
Cohesion: 0.09
Nodes (26): SettingsActionState, LocationsList(), roleLabel(), SettingsPage(), tabCopy, NewRoomTypePage(), RoomRow, RoomsList() (+18 more)

### Community 1 - "Guest Management Actions and Forms"
Cohesion: 0.12
Nodes (20): createGuestAction(), duplicateState(), GuestActionState, invalidInput(), updateGuestAction(), GuestDefaults, GuestForm(), GuestProfilePage() (+12 more)

### Community 2 - "Housekeeping Status Management and Board"
Cohesion: 0.06
Nodes (49): bedIdSchema, bedStatusSchema, RoomStatusActionState, updateRoomStatusAction(), filters, groupByFloor(), HousekeepingPage(), RoomStatusControl() (+41 more)

### Community 3 - "Reservation Lifecycle and Validation Rules"
Cohesion: 0.06
Nodes (42): DashboardPage(), createReservationAction(), databaseMessage(), invalidInput(), ReservationActionState, searchGuestsAction(), updateReservationAction(), GuestCombobox() (+34 more)

### Community 4 - "Interactive Calendar and Date Timeline Grid"
Cohesion: 0.12
Nodes (29): CalendarControls(), RoomStatus, CalendarPage(), CalendarStyle, dateIndex(), dayLabel(), groupBy(), guestLabel() (+21 more)
...
Cohesion: 0.14
Nodes (34): bulkSchema, bulkUpdateRoomsAction(), createLocationAction(), createRoomAction(), createRoomTypeAction(), createStaffAction(), deleteLocationAction(), deleteRoomAction() (+26 more)
...
## Knowledge Gaps
- **293 isolated node(s):** `nextConfig`, `name`, `version`, `type`, `private` (+288 more)
...
- **Why does `verifySession` connect `queries.ts` to `Settings Actions and Admin Configurations`, `Guest Management Actions and Forms`, `Housekeeping Status Management and Board`, `Reservation Lifecycle and Validation Rules`, `Interactive Calendar and Date Timeline Grid`, `Authenticated Layout Shell and Navigation`, `validation.ts`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `db` connect `Housekeeping Status Management and Board` to `Settings Actions and Admin Configurations`, `Guest Management Actions and Forms`, `Reservation Lifecycle and Validation Rules`, `Interactive Calendar and Date Timeline Grid`, `queries.ts`?**
