  ...
  return <div className={styles.page}>
    ...
    <div className={styles.profileGrid}>
      <main className={styles.profileMain}>
        ...
        <section className={styles.formPanel} aria-labelledby="edit-title"><h2 id="edit-title">Edit detail tamu</h2><GuestForm action={updateAction} defaults={guest} submitLabel="Simpan perubahan" cancelHref={`/dashboard/guests/${guest.id}`} /></section>
      </main>
